"use strict";
const taskButton = document.querySelector('#taskAddButton');
const taskText = document.querySelector('#taskTextInput');
const taskList = document.querySelector('#task--list');
const fastTaskButton = document.querySelector('#fastestTaskButton');
const containerFastTask = document.querySelector('#fastTask');
